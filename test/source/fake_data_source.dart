...
class FakeDataSource {
  ...
  static Future<LatestCurrency> get latestCurrency => File(
    _testPath("source/latest_currency.json"),
  ).readAsString().then((value) => jsonDecode(value)).then((value) => LatestCurrency.fromJson(value));
